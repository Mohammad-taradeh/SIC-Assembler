...
def SymbolTable():
    ...
    fout2.write(ToolsFile.ProgName() + ' ' + ToolsFile.startingadress() + '\n')
    fout2.write('\n')
    print("SYMTAB:\n")
    print(ToolsFile.ProgName() + ' ' + ToolsFile.startingadress() + '\n')
